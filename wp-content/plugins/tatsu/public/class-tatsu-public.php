	...
	public function enqueue_styles() {
		...
		if( !empty( $suffix ) ) {
			...
			if(is_tatsu_standalone()){ 
				//spyro theme css
				wp_enqueue_style( 'tatsu-theme-main', $assets_base_url . 'css/theme-main.min.css', array(), $this->version, 'all' );
			}
		}else{
			...
			if(is_tatsu_standalone()){
				//spyro theme css
				wp_enqueue_style( 'tatsu-theme-main', $assets_base_url . 'css/theme-main.css', array(), $this->version, 'all' );
			}
		}
